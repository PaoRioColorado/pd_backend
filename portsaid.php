  ...
  <section>
    <div class="container">
      <div class="row">
        ...
        $consulta="SELECT * FROM `ropa` WHERE `marca` = 'Portsaid' ";
        ...
        while ($reg = mysqli_fetch_array($datos)) {?>
          <div class="card col-sm-12 col-md-6 col-lg-3">
            <img class="card-img-top" src="data:image/jpg;base64, <?php echo base64_encode($reg['imagen'])?>" alt="ropa Portsaid" width="" height="")>
